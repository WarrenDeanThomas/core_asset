# Generated by Django 3.2.13 on 2022-05-20 04:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('main_img', models.ImageField(blank=True, default='images/avatar_pet.jpg', null=True, upload_to='images/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_date', models.DateTimeField(blank=True, default=django.utils.timezone.now, null=True)),
                ('number_of_pets', models.PositiveSmallIntegerField(blank=True, default=5, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity_desc', models.CharField(blank=True, max_length=250, null=True)),
                ('date_of_activity', models.DateField(blank=True, null=True)),
                ('core', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='core_reminder', to='core.core')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_desc', models.CharField(blank=True, max_length=250, null=True)),
                ('date_of_event', models.DateField(blank=True, null=True)),
                ('file', models.FileField(blank=True, null=True, upload_to='documents/')),
                ('created_date', models.DateTimeField(blank=True, default=django.utils.timezone.now, null=True)),
                ('core', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='core', to='core.core')),
            ],
            options={
